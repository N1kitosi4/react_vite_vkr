  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        const { data: stats } = await axios.get("http://localhost:8000/reviews/profile_stats", {
            headers: {
      ...
      <div className="container">
        ...
        <div className="profile-info">
          <div className="profile-info__avatar">
            <img
              src={user.avatar ? `http://127.0.0.1:8000${user.avatar}` : book}
              alt="User Avatar"
          ...
          >
            {reviews.map((review) => (
              <SwiperSlide
                key={review.id}
                style={{
                  backgroundImage: `url(http://127.0.0.1:8000${review.book_img})`,
...
//           >
//             {reviews.map((review) => (
//               <SwiperSlide key={review.id} style={{backgroundimage: review.img}}>
//                 <NavLink to={`/review/${review.id}`} className="review-card">
...
//                   </p>
//                   <p className="review-card__date">
//                     Дата отзыва: {review.formattedDate}
//                   </p>
//                 </NavLink>
//               </SwiperSlide>
//             ))}
